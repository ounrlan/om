  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          <span className="pointer-events-none hidden translate-x-2 rounded-full border border-white/10 bg-ink/90 px-4 py-2 text-xs font-medium text-cream opacity-0 backdrop-blur-md transition-all duration-400 ease-luxe group-hover:translate-x-0 group-hover:opacity-100 sm:block">
            Bize yazın, hemen dönelim
          </span>
          <span className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-luxe transition-transform duration-400 ease-luxe group-hover:scale-110">
