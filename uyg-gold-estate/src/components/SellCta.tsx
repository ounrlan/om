...
const inputClass =
  "w-full rounded-2xl border border-white/10 bg-ink/70 px-5 py-4 text-sm text-cream placeholder:text-stone/60 outline-none transition-all duration-300 focus:border-gold/60 focus:shadow-gold-glow";
  ...
  return (
    <section id="sat" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(60% 80% at 20% 30%, rgba(201,169,98,0.10), transparent 60%), radial-gradient(50% 70% at 85% 75%, rgba(59,58,38,0.5), transparent 65%)",
        }}
      />
      <div className="container-luxe relative grid items-center gap-14 lg:grid-cols-2">
        <Reveal>
          ...
          <p className="mt-6 max-w-lg text-base leading-relaxed text-stone">
            Formu doldurun; uzman ekibimiz güncel piyasa verileriyle ücretsiz
            değerleme yapsın, mülkünüzü doğru alıcıyla buluştursun. Dilerseniz
            bize doğrudan da ulaşabilirsiniz.
          </p>
        ...
        <Reveal delay={0.15}>
          <form
            onSubmit={submit}
            className="glass rounded-card bg-ink/60 p-7 shadow-luxe-lg sm:p-9"
          ...
          >
            ...
            <p className="mt-4 text-center text-[11px] leading-relaxed text-stone/70">
