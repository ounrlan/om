      ...
      <div className="container-luxe">
        <div className="flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          <SectionHeading
            ...
            accent="portföyümüz."
            description="İlanlarımız sahibinden.com mağazamızda yayınlanır; karttaki 'Görüntüle' bağlantısı sizi ilanın sahibinden.com sayfasına götürür."
          />
          <Reveal delay={0.15} className="mb-14 shrink-0">
            <div className="inline-flex rounded-full border border-mist bg-pearl p-1 shadow-soft">
              {TABS.map((t) => (
                <button
                  key={t.key}
        ...
        <Reveal className="mt-14 text-center">
          <a
            ...
            target="_blank"
            rel="noopener"
            className="btn-outline group !border-slate/25 hover:!border-gold"
          >
