...
// Display — yüksek kontrastlı, ince ağırlıklı klasik serif. Dev puntoda kullanılır.
...
export default function RootLayout({
  ...
  return (
    <html lang="tr">
      <body
        className={`${cormorant.variable} ${jost.variable} ${plexMono.variable} bg-night font-body font-light text-cream antialiased`}
      >
        <script
